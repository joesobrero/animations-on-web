...
import Spinner from "../../_components/display/spinner";
...
export default function FeedbackComponentCSS() {
  ...
  // @ts-expect-error - Type mismatch is safe here as we're only using the ref for click detection
  ...
  return (
    <div className="feedback-wrapper">
      <motion.button
        ...
        layoutId="background"
      >
        <motion.span className="text-base-100" layoutId="placeholder">
          Feedback
        </motion.span>
      </motion.button>
      <AnimatePresence>
